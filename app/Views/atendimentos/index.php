                ...
                <div class="modal-body">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows="3"
                            placeholder="Obrigatória ao concluir"
                        ></textarea>
                    </div>
                </div>
...
async function carregarAtendimentos() {
    try {
        ...
        tbody.innerHTML = atendimentos.map(
            atendimento => {
                ...
                return `
                    <tr>
                        ...
                        <td>
                            ${AtendeLabApi.escape(pessoa)}
                        </td>

                        <td>
                            ${AtendeLabApi.escape(tipo)}
                        </td>
...
formAtendimento.addEventListener(
    'submit',
    async event => {
...
document.getElementById('formStatus').addEventListener(
    'submit',
    async event => {
        event.preventDefault();
