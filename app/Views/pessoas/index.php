...
async function carregarPessoas() {
    try {
        ...
        const dados = AtendeLabApi.toList(resposta);
        ...
        tbody.innerHTML = dados.map(pessoa => `
            <tr>
                ...
                <td>
                    ${AtendeLabApi.escape(pessoa.email)}
                </td>

                <td>
                    ${AtendeLabApi.escape(pessoa.curso || '')}
                </td>

                <td>
                    ${AtendeLabApi.escape(pessoa.periodo || '')}
                </td>
                ...
                <td class="text-end">
                    <button
                        ...
                        type="button"
                        onclick="editarPessoa(${Number(pessoa.id)})"
                    >
                        Editar
                    </button>
                    ...
                    <button
                        ...
                        type="button"
                        onclick="inativarPessoa(${Number(pessoa.id)})"
                    >
                        Inativar
                    </button>
                </td>
...
async function editarPessoa(id) {
    try {
        ...
        for (const [campoNome, campoValor] of Object.entries(pessoa)) {
            const campo = formPessoa.elements.namedItem(campoNome);

            if (campo) {
                campo.value = campoValor ?? '';
            }
        }
    } catch (error) {
        AtendeLabApi.showAlert(
